...
async function generatePackingListStaticPages() {
  try {
    console.log('🚀 Starting static packing list page generation...');
    ...
    // Generate index file with all packing lists (if needed)
    ...
    console.log('🎉 Static packing list page generation completed!');
    console.log(`📁 Static pages saved to: ${staticDir}`);
...
// Run the function
generatePackingListStaticPages().catch(console.error);
